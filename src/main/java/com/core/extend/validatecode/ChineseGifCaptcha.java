package com.core.extend.validatecode;
...
public class ChineseGifCaptcha extends ChineseCaptchaAbstract {
    ...
    private BufferedImage graphicsImage(Color fontcolor, char[] strs, int flag) {
        ...
        ac3 = AlphaComposite.getInstance(AlphaComposite.SRC_OVER, 0.15f);
        g2d.setComposite(ac3);
        drawLine(10, g2d.getColor(), g2d);
        // 画干扰圆圈
        drawOval(10, g2d.getColor(), g2d);
