...
<#macro page1 page objID callback showCount="5">
	...
	<a onclick="AjaxClick2('${objID}','1','${callback}','${showCount}');"><<第一页</a>
	<a onclick="AjaxClick2('${objID}','${prePageNo}','${callback}','${showCount}');"><上一页</a>
	<span>第 ${page.pageNo}/ ${page.totalpage} 页</span>
	<a onclick="AjaxClick2('${objID}','${nextPageNo}','${callback}','${showCount}')">下一页></a>
	<a onclick="AjaxClick2('${objID}','${page.totalpage}','${callback}','${showCount}');">最后一页>></a>
	<span>跳转至
